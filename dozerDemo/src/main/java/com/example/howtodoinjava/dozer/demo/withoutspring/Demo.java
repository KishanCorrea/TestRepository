...
import com.example.howtodoinjava.dozer.models.Address;
...
public class Demo {
	...
	public static void main(String[] args) 
	{
		...
		sourceObject.getStudents().add(new Student("S1", "C1", "diffField1",new Address("ABC","ABC","ABC")));
		//sourceObject.getStudents().add(new Student("S2", "C2", "diffField2",new Address("ABC","ABC","ABC")));
		//sourceObject.getStudents().add(new Student("S3", "C3", "diffField3",new Address("ABC","ABC","ABC")));
